# main.py — Generated by VIA for: Build me an AI powered mental health tracker with mood logging, stress analysis and wellness recommendations
...
app = FastAPI(
    title="Build Me An Ai Powered Mental",
...
@app.get("/")
def root():
    return {"app": "Build Me An Ai Powered Mental", "status": "running", "generated_by": "VIA"}
